        ...
        <div>
          <div className="photos-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 4 }}>
            {PHOTOS.map((p, i) => {
              ...
              return (
                <div key={i} className="photo-card" style={{ borderRadius: 16, overflow: "hidden", boxShadow: "0 4px 20px rgba(0,0,0,0.08)", gridRow: tall ? "span 2" : "span 1", position: "relative", height: tall ? 420 : 200, background: NAVY }}>
                  {!imgErrors[i] && (

      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "24px 20px 80px" }}>
        ...
        {tab === "documents" && (<div style={card}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 14, flexWrap: "wrap", gap: 8 }}>
            ...
            <button style={{ padding: "7px 14px", background: CY, color: "#fff", border: "none", borderRadius: 6, fontSize: 11, fontWeight: 600, cursor: "pointer" }}>⬆ Upload document</button>
          </div>
          {c.documents.map((d, i) => (
            <div key={d.id} style={{ padding: "12px 0", borderBottom: i < c.documents.length - 1 ? "0.5px solid #f0f0f0" : "none", display: "flex", gap: 12, alignItems: "center" }}>
              ...
              <button style={{ padding: "6px 10px", background: "transparent", border: "0.5px solid #ddd", borderRadius: 6, fontSize: 11, color: "#666", cursor: "pointer", whiteSpace: "nowrap" }}>↓ Download</button>
            </div>
          ))}
        </div>)}
          ...
          {c.invoices.map((inv, i) => (
            <div key={inv.id} style={{ padding: "14px 0", borderBottom: i < c.invoices.length - 1 ? "0.5px solid #f0f0f0" : "none", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 8 }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                ...
                {inv.status === "Outstanding" && <button style={{ padding: "6px 12px", background: CY, color: "#fff", border: "none", borderRadius: 6, fontSize: 11, fontWeight: 600, cursor: "pointer" }}>Pay now</button>}
              </div>
            </div>
          ))}
        </div>)}

...
import CRMLive from "./affinity_core_crm_live";
import Rates from "./affinity_core_rates";
...
const SEARCH_INDEX = [
  ...
  {type:"Module",  label:"Documents (DMS)",                  sub:"Filing, search, retention, folders",mod:"dms"},
  {type:"Module",  label:"Rates & allocations",               sub:"Payroll rates, group allocations",mod:"rates"},
...
export default function AffinityCore(){
  ...
  const content=()=>{
    ...
    switch(mod){
      ...
      case "dms": return <DMS onNav={setMod}/>;
      case "rates": return <Rates onNav={setMod}/>;
